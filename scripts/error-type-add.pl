...
##
##   usage:perl $0 sam_file 454-or-illumina-or-pacbio
####################################################
...
my $whole;
my $percentage;
my $usage="perl $0 sam_file 454-or-illumina-or-pacbio";
...
if(($ARGV[1] ne "454")&&($ARGV[1] ne "illumina")&&($ARGV[1] ne "pacbio"))
{
	print "Please input the platform type: 454 or illumina or pacbio \n";
	print "error!\n$usage\n";
	exit;
}
...
close IN;
print "total_error number is : $total_error\n";
